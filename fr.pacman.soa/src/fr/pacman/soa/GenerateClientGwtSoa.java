 ...
 * @generated NOT
 */
public class GenerateClientGwtSoa extends PacmanGenerator_Abs {
	/**
	 * The name of the module.
	 */
	public static final String c_MODULE_FILE_NAME = "generateClientGwtSoa";
...
//   }
	 ...
	 *                     loaded.
	 */
	public GenerateClientGwtSoa(final EObject p_model, final File p_targetFolder,
		...
		if (p_model instanceof CDOResource) {
			_TEMPLATE_NAMES = new String[] { "GenerateClientGwtSystem" };
		} else if (p_model instanceof Namespace) {
			_TEMPLATE_NAMES = new String[] { "GenerateClientGwtPackage" };
		} else if (p_model instanceof DTO) {
			_TEMPLATE_NAMES = new String[] { "GenerateClientGwtDto" };
		} else if (p_model instanceof Component) {
			_TEMPLATE_NAMES = new String[] { "GenerateClientGwtComponent" };
		} else if (p_model instanceof Service) {
			_TEMPLATE_NAMES = new String[] { "GenerateClientGwtService" };
		} else {
	 ...
	 *                     loaded.
	 */
	public GenerateClientGwtSoa(final URI p_modelURI, final File p_targetFolder,
			final List<? extends Object> p_arguments) throws IOException {
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateClientGwtSoa v_generator = new GenerateClientGwtSoa(v_modelURI, v_folder, v_arguments);
