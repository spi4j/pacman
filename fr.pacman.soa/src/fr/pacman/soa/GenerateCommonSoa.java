...
public class GenerateCommonSoa extends PacmanGenerator_Abs {
	 ...
	 */
	public static final String c_MODULE_FILE_NAME = "generateCommonSoa";
...
//   }
	 ...
	 *                     loaded.
	 */
	public GenerateCommonSoa(final EObject p_model, final File p_targetFolder, final List<? extends Object> p_arguments)
			throws IOException {
		...
		if (p_model instanceof Namespace) {
			...
			_TEMPLATE_NAMES = new String[] { "GenerateCommonDto" };
	 ...
	 *                     loaded.
	 */
	public GenerateCommonSoa(final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments)
			throws IOException {
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateCommonSoa v_generator = new GenerateCommonSoa(v_modelURI, v_folder, v_arguments);
