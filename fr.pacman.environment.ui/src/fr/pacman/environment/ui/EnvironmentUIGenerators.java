package fr.pacman.environment.ui;
...
import fr.pacman.environment.GenerateCommonTypes;

/**
 * UI Generator for personalized types based on ".environment" model file.
 * 
 * @author MINARM
 */
public class EnvironmentUIGenerators extends PacmanUIGenerator_Abs {
	 ...
	 */
	public EnvironmentUIGenerators(final IFile p_selected) {
		super(p_selected);
	}
	...
	protected List<PacmanGenerator_Abs> getGenerators() {
		...
		v_generators.add(new GenerateCommonTypes());
		return v_generators;
	}
	...
	protected List<PacmanUIGenerator_Enum> getCompatibleModels() {
		return Arrays.asList(PacmanUIGenerator_Enum.ENVIRONMENT);
	}
