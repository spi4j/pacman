...
/**
 * Entry point of the 'GenMainSql' generation module.
 * 
 * @generated NOT
 */
public class GenerateSql extends PacmanGeneratorOld_Abs
{
   /**
    * The name of the module.
    */
   public static final String c_MODULE_FILE_NAME = "generateSql";
    ...
    */
   public GenerateSql (final EObject p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
    ...
    *            This can be thrown in three scenarios : the module cannot be found, it cannot be loaded, or the model cannot be loaded.
    */
   public GenerateSql (final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
      super(p_modelURI, p_targetFolder, p_arguments);
   }
   ...
   public static void main (final String[] p_args)
   {
      try
      {
         ...
         else
         {
            ...
            final GenerateSql v_generator = new GenerateSql(v_modelURI, v_folder, v_arguments);
