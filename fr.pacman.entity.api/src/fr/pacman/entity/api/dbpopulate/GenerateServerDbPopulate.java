...
/**
 * SQL generator, write all necessary SQL scripts (creation, deletion,
 * initialization) for all selected databases.
 * 
 * @author MINARM
 */
public class GenerateServerDbPopulate extends PacmanGenerator_Abs {
	...
	public String getModuleQualifiedName() {
		return "fr::pacman::entity::api::dbpopulate::generateServerDbPopulate";
	}
	...
	protected Map<String, SelectionType_Enum> getTemplates() {
		...
		v_templates.put("generateDbPopulate", SelectionType_Enum.FILE);
		return v_templates;
	}
}
