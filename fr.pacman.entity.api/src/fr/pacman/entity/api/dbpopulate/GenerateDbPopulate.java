...
/**
 * Entry point of the 'GenerateDbPopulate' generation module.
 * 
 * @generated NOT
 */
public class GenerateDbPopulate extends PacmanGeneratorOld_Abs
{
   /**
    * The name of the module.
    */
   public static final String c_MODULE_FILE_NAME = "generateDbPopulate";
    ...
    */
   public GenerateDbPopulate (final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
   ...
   public static void main (final String[] p_args)
   {
      try
      {
         ...
         else
         {
            ...
            final GenerateDbPopulate v_generator = new GenerateDbPopulate(v_modelURI, v_folder, v_arguments);
