 ...
 * @generated NOT
 */
public class GenerateEntityItfApiSoaLight extends PacmanGeneratorOld_Abs
{

   /**
    * The name of the module.
    */
   public static final String c_MODULE_FILE_NAME = "generatePersistenceApiSoaLight";
    ...
    */
   public GenerateEntityItfApiSoaLight (final EObject p_model, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
      super(p_model, p_targetFolder, p_arguments);
      if (p_model instanceof CDOResource)
      {
         _TEMPLATE_NAMES = new String[]
         {"generatePersistenceApi" };
      }
      else if (p_model instanceof Namespace)
      {
         _TEMPLATE_NAMES = new String[]
         {"generatePersistenceApiNamespace" };
      }
      else if (p_model instanceof Entity)
      {
         _TEMPLATE_NAMES = new String[]
         {"generatePersistenceApiEntity" };
      }
      else
      {
    ...
    *            This can be thrown in three scenarios : the module cannot be found, it cannot be loaded, or the model cannot be loaded.
    */
   public GenerateEntityItfApiSoaLight (final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
   ...
   public static void main (final String[] p_args)
   {
      try
      {
         ...
         else
         {
            ...
            final GenerateEntityItfApiSoaLight v_generator = new GenerateEntityItfApiSoaLight(v_modelURI, v_folder, v_arguments);
