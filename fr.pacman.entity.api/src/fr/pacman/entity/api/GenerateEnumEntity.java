 ...
 * @generated NOT
 */
public class GenerateEnumEntity extends PacmanGeneratorOld_Abs
{
   /**
   ...
   public static final String c_MODULE_FILE_NAME = "generateEnumEntity";
    ...
    */
   public GenerateEnumEntity (final EObject p_model, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
    ...
    *            This can be thrown in three scenarios : the module cannot be found, it cannot be loaded, or the model cannot be loaded.
    */
   public GenerateEnumEntity (final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
   ...
   public static void main (final String[] p_args)
   {
      try
      {
         ...
         else
         {
            ...
            final GenerateEnumEntity v_generator = new GenerateEnumEntity(v_modelURI, v_folder, v_arguments);
