...
/**
 * Entry point of the 'GeneratePersistenceApiWithoutMatch' generation module.
 *
 * @generated
 */
public class GeneratePersistenceApiSoaLight extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/fr/pacman/entity/api/generatePersistenceApiSoaLight";
  ...
  /**
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generatePersistenceApi", "generatePersistenceApiBlock", "generatePersistenceApiEntity" };
  ...
  /**
     ...
     * @generated
     */
    public GeneratePersistenceApiSoaLight() {
     ...
     * @generated
     */
    public GeneratePersistenceApiSoaLight(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
     ...
     * @generated
     */
    public GeneratePersistenceApiSoaLight(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GeneratePersistenceApiSoaLight generator = new GeneratePersistenceApiSoaLight(modelURI, folder, arguments);
