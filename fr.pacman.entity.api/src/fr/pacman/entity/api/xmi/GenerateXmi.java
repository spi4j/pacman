...
/**
 * Entry point of the 'GenXmi' generation module.
 * 
 * @generated NOT
 */
public class GenerateXmi extends PacmanGenerator_Abs
{
    ...
    */
   public static final String c_MODULE_FILE_NAME = "generateXmi";
    ...
    */
   public GenerateXmi (final EObject p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
    ...
    *            This can be thrown in three scenarios : the module cannot be found, it cannot be loaded, or the model cannot be loaded.
    */
   public GenerateXmi (final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
      super(p_modelURI, p_targetFolder, p_arguments);
   }
   ...
   public static void main (final String[] p_args)
   {
      try
      {
         ...
         else
         {
            ...
            final GenerateXmi v_generator = new GenerateXmi(v_modelURI, v_folder, v_arguments);
