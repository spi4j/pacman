 ...
 * @generated NOT
 */
public class GeneratePersistenceApi extends PacmanGeneratorOld_Abs
{

   /**
    * The name of the module.
    */
   public static final String c_MODULE_FILE_NAME = "generatePersistenceApi";
    ...
    */
   public GeneratePersistenceApi (final EObject p_model, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
    ...
    *            This can be thrown in three scenarios : the module cannot be found, it cannot be loaded, or the model cannot be loaded.
    */
   public GeneratePersistenceApi (final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
   ...
   public static void main (final String[] p_args)
   {
      try
      {
         ...
         else
         {
            ...
            final GeneratePersistenceApi v_generator = new GeneratePersistenceApi(v_modelURI, v_folder, v_arguments);
