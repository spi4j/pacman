...
public static String sanitizeJavaService(final String p_s){return sanitize(p_s);}
    ...
    * 
    * @param p_str
    *           la chaine à écrire à la place de ABCDEF
    * @param p_size
    *           la taille de la ligne à générer
...
public static String escapeJavaService(final String p_str){return escape(p_str);}
    ...
    * @param p_chaine
    *           la chaine originale
    * @param p_patternSeparation
    *           le pattern de séparation
    * @param p_nouveauSeparateur
    *           la nouvelle chaine de séparation
   ...
   // if (v_resource == null)
   // {
   // return "[ERROR] Impossible de trouver le modèle pour l'objet suivant : " + p_o.toString();
   // }
   // final URI v_uri = v_resource.getURI();
   // if (v_uri == null)
   // {
   // return "[ERROR] Impossible de calculer l'URI de la ressource suivante : " + v_resource.toString();
   // }
   // return getModuleFolderFromUri(v_uri);
   // }
   // catch (Throwable v_t)
   // {
   // return "[ERROR] " + v_t.toString() + "\n\nOBJECT = " + p_o + "\nRESOURCE = " + p_o.eResource() + "\nURI = "
