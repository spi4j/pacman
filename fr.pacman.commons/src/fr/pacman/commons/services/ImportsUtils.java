...
/**
 * Utility class to write imports. Always remember that the java generator that uses this service must absolutely have the Acceleo cache disabled, otherwise you will have unpredictable results. To disable the cache, set the value to "false" in the "getSwitchQueryCache ()" method.
 * 
...
public class ImportsUtils
{
   ...
   /**
    * Initialize the static service, reset the lists and browse the ObeoDSMObject to add automatically detectable imports.
    * 
    * @param p_object
    *           : The object for adding imports.
    * @param p_onlyPublic
    *           : Set to true if the service must only set the imports for "public" operations.
    * @param p_notInAcount
    *           : Set a list of imports separated by ',' if some of automatically detectable imports must be ignored.
    * @return
    */
...
public static String initImportsJavaService(final ObeoDSMObject p_object,final Boolean p_onlyPublic,final String p_notInAccount){return initImports(p_object,p_onlyPublic,p_notInAccount);}
    ...
    * 
    * @param p_object
    *           : The object for traceability.
    * @param p_import
    *           : The full package and name for the import.
    * @param p_write
    *           : Condition given by a method given by the developer.
    * 
    * @return Must always return null value as the query must not write anything in the file.
    */
...
public static String addImportJavaService(final ObeoDSMObject p_object,final String p_import,final Boolean p_write){return addImport(p_object,p_import,p_write);}
    ...
    * 
    * @param p_service
    *           : The service to browse.
    * @param p_onlyPublic
    *           : If set to 'true', only for public operations.
    */
    ...
    * 
    * @param p_entity
    *           : The Entity object to be analyzed.
    */
    ...
    * 
    * @param p_reference
    *           : The Reference object to be analyzed.
    */
    ...
    * 
    * @param p_params
    *           : The list of parameters for an operation.
    */
    ...
    * 
    * @param p_attributes
    *           : The list of all attributes for the structured object.
    * @param p_references
    *           : The list of all references for the structured object.
    */
    ...
    *           : If 'true' add the 'List' import.
    */
   private static void initWithBasicMultiplicity (final MultiplicityKind p_multiplicity)
   {

      if (MultiplicityKind.ONE_STAR_LITERAL == p_multiplicity || MultiplicityKind.ZERO_STAR_LITERAL == p_multiplicity)
      {
    ...
    * 
    * @param p_type
    *           : The string format type for the parameter.
    */
    ...
    * 
    * @param p_import
    *           : The basic detectable import to add.
    */
...
public static String flushImportsJavaService(final ObeoDSMObject p_object){return flushImports(p_object);}
    ...
    * 
    * @param p_notInAccount
    *           : The list of imports to ignore if automatically detected.
    */
   ...
   /**
    * Reset a specific list for additional SQL types (if needed). This reset is ordered by the generator.
    */
