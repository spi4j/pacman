 ...
 */
public abstract class PacmanGeneratorOld_Abs extends AbstractAcceleoGenerator {
	 ...
	 *                     loaded.
	 */
	public PacmanGeneratorOld_Abs(final EObject p_model, final File p_targetFolder,
	 ...
	 *                     loaded.
	 */
	public PacmanGeneratorOld_Abs(final URI p_modelURI, final File p_targetFolder,
			final List<? extends Object> p_arguments) throws IOException {
