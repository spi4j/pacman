 ...
 *******************************************************************************/
package fr.pacman.cinematic.swing;
 ...
 * @generated NOT
 */
public class GenerateCinematicSwing extends PacmanGeneratorOld_Abs {

	/**
	 * The name of the module.
	 */
	public static final String c_MODULE_FILE_NAME = "generateCinematicSwing";
	 ...
	 *                     loaded.
	 */
	public GenerateCinematicSwing(final EObject p_modelURI, final File p_targetFolder,
	 ...
	 *                     loaded.
	 */
	public GenerateCinematicSwing(final URI p_modelURI, final File p_targetFolder,
			final List<? extends Object> p_arguments) throws IOException {
		super(p_modelURI, p_targetFolder, p_arguments);
	}
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateCinematicSwing v_generator = new GenerateCinematicSwing(v_modelURI, v_folder,
						v_arguments);
