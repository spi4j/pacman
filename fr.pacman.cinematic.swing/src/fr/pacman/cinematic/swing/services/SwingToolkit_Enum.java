...
/**
 * Enumeration des widgets connus du toolkit Swing.
 * @author MINARM
 */
public enum SwingToolkit_Enum implements SwingToolkitWidget_Itf, InterfaceToolkitWidget_Itf
{

   // Rajouter ici les composants spécifiques à Swing, issus du toolkit Swing
   NONE("", "", "", "", "", "");

   public static final String c_toolkitName = "SWING";
    ...
    */
   private SwingToolkit_Enum (final String p_name, final String p_implementationClass,
