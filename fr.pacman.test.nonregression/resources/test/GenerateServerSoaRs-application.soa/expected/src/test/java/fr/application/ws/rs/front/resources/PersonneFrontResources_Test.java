   ...
   * 
	...
	public void testFindPersonneById() {
		...
		try {
			...
			// for findPersonneById_Personne_personne_Long_identifiant
			...
			// for response findPersonneById_Personne_personne_Long_identifiant
   ...
   * 
	...
	public void testFindPersonneByName() {
		...
		try {
			...
			// for findPersonneByName_Personne_personne_String_nom
			...
			// for response findPersonneByName_Personne_personne_String_nom
   ...
   * 
	...
	public void testFindPersonneByIdFromRest() {
		...
		try {
			...
			// for response findPersonneByIdFromRest_Personne_personne_Long_identifiant
