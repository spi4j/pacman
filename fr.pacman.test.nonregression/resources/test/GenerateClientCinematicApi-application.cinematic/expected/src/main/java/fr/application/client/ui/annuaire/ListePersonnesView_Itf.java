...
public interface ListePersonnesView_Itf extends View_Itf
{
   ...
   // cbGrade_ERREUR [ Widget sans nom]
   ...
   // btActualiser_ERREUR [ Widget sans nom]
   ...
   // btCreer_ERREUR [ Widget sans nom]
   ...
   // btModifier_ERREUR [ Widget sans nom]
   ...
   // btVisualiser_ERREUR [ Widget sans nom]
   ...
   // btSupprimer_ERREUR [ Widget sans nom]
