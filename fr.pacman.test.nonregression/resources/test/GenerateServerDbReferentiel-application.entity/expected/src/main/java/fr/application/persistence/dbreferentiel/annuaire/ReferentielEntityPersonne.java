...
public final class ReferentielEntityPersonne
{
    ...
    // Constantes ReferentielEntityPersonne
   ...
   // Attributs ReferentielEntityPersonne
   ...
   public static void chargeEntity ()
   {
      ...
      try
      {
        ...
        String [] v_csvLine;
   	    ...
   	    // PreTraitement ReferentielEntityPersonne
        ...
        while ( ( v_csvLine = v_csvReader.readNext() ) != null )
        {
          ...
          // PreSave ReferentielEntityPersonne
          ...
          // PostSave ReferentielEntityPersonne
      ...
      // PostTraitement ReferentielEntityPersonne
   ...
   // Methodes ReferentielEntityPersonne
