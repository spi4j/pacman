...
/**
 * L'énumération définissant les informations de chaque attribut pour le type 'User'.
 * @author safr@n
 */
public enum UserAttributesEnum implements AttributesNames_Itf
{
   ...
   /** email. */
   email("email", "", String.class, true, -1),
   /** password. */
   password("password", "", String.class, true, -1),
   /** name. */
   name("name", "", String.class, true, -1),
   /** carts. */
   carts("carts", "", List.class, false, -1);
    ...
    */
   private UserAttributesEnum (final String name, final String description, final Class<?> classType, final boolean mandatory, final int size)
   {
      this.name = name;
   ...
   public Method getGetterMethod ()
   {
      ...
      {
         getterMethod = DtoAttributeHelper.getInstance().getGetterMethodForAttribute(UserDto.class, getName());
      }
      return getterMethod;
   }
   ...
   public Method getSetterMethod ()
   {
      ...
      {
         setterMethod = DtoAttributeHelper.getInstance().getSetterMethodForAttribute(UserDto.class, getName(), getType());
      }
      return setterMethod;
   }
