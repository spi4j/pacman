...
public final class TestParamPersistence extends ParamPersistence_Abs implements TestParamAppli
{
   ...
   protected void initElemParamPersistence () // NOPMD
   {
      ...
      // fr.test.persistence.api.main.AuthorEntity
      ...
      // End of user code
      // fr.test.persistence.api.main.BookEntity
      ...
      // End of user code
      // fr.test.persistence.api.main.PurchaseOrderEntity
      ...
      // End of user code
      // fr.test.persistence.api.main.ShoopingCartLineEntity
      ...
      // End of user code
      // fr.test.persistence.api.main.ShoppingCartEntity
      ...
      // End of user code
      // fr.test.persistence.api.main.UserEntity
   ...
   private ResourcePhysical_Abs createResourcePhysical ()
   {
	  ...
	  if(h2Mode){
			...
			resourcePhysical = new DefaultResourcePhysical("jdbc:h2:" + CHEMINBASEH2, "sa", "",
