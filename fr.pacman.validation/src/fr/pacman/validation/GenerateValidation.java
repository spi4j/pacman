 ...
 * @generated NOT
 */
public class GenerateValidation extends PacmanGeneratorOld_Abs
{

   /**
    * The name of the module.
    */
   public static final String c_MODULE_FILE_NAME = "generateValidation";

   /**
    * The name of the templates that are to be generated.
    */
   public static final String[] c_TEMPLATE_NAMES =
   {"generateValidationGraal", "generateValidationRequirement", "generateValidationSoa", "generateValidationEntity" };

   /**
    * Allows the public constructor to be used. Note that a generator created
    * this way cannot be used to launch generations before one of
    * initialize(EObject, File, List) or initialize(URI, File, List) is called.
    * <p>
    ...
    */
   public GenerateValidation (final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments) throws IOException
   {
   ...
   public static void main (final String[] p_args)
   {
      try
      {
         ...
         else
         {
            ...
            final GenerateValidation v_generator = new GenerateValidation(v_modelURI, v_folder, v_arguments);
