 ...
 */
public class GenerateSoaRsFromEObject extends SafranGeneratorOld_Abs<EObject> {
	...
	@Override
	protected List<PacmanGeneratorOld_Abs> getPacmanGenerators(EObject p_input, List<? extends Object> p_arguments)
			throws IOException {
