...
/**
 * UI Generator for rs client based on ".soa" model file.
 * 
 * @author MINARM
 */
public class SoapiFirstUIGenerators extends PacmanUIGenerator_Abs {
	 ...
	 */
	public SoapiFirstUIGenerators(final IFile p_selected) {
		super(p_selected);
	}
	...
	protected List<PacmanGenerator_Abs> getGenerators() {
		...
		v_generators.add(new GenerateServerSoaRs());
		v_generators.add(new GenerateCommonSoaRs());
		return v_generators;
	}
