package fr.pacman.cinematic.gwt.ui;
 ...
 * @author MINARM
 */
public class GwtUIGenerators extends PacmanUIGenerator_Abs {
	 ...
	 */
	public GwtUIGenerators(final IFile p_selected) {
		super(p_selected);
	}
	...
	protected List<PacmanGenerator_Abs> getGenerators() {
		...
		v_generators.add(new GenerateClientCinematicGwt());
		return v_generators;
	}
	...
	protected List<String> getIncompatibleProperties() {
		return Arrays.asList(ProjectProperties.getIsLibraryRs(),
				"GWT".equalsIgnoreCase(ProjectProperties.getClient()) ? "true" : "false");
	}
