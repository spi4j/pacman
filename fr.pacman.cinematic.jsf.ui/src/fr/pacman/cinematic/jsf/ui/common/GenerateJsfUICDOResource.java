 ...
 */
public class GenerateJsfUICDOResource extends SafranGeneratorOld_Abs<CDOResource> {
	 ...
	 */
	public GenerateJsfUICDOResource(final CDOResource p_modelURI, final List<? extends Object> p_arguments) {
	...
	protected List<PacmanGeneratorOld_Abs> getPacmanGenerators(final CDOResource p_file,
		...
		v_generators.add(new GenerateCinematicApi(p_file, getClientJsfProject(), p_arguments));
		v_generators.add(new GenerateCinematicJsf(p_file, getClientJsfProject(), p_arguments));
		return v_generators;
	}
