 ...
 */
public class GenerateJsfUI extends SafranGenerator_Abs<IFile> {
	...
	@Override
	protected List<PacmanGenerator_Abs> getPacmanGenerators(final IFile p_file, final List<? extends Object> p_arguments)
			throws IOException {
