package fr.pacman.entity.xmi.ui;
 ...
 * @author MINARM
 */
public class XmiUIGenerators extends PacmanUIGenerator_Abs {
	 ...
	 */
	public XmiUIGenerators(final IFile p_selected) {
		super(p_selected);
	}
	...
	protected List<PacmanGenerator_Abs> getGenerators() {
		...
		v_generators.add(new GenerateServerXmi());
		return v_generators;
	}
