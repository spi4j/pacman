 ...
 */
public class GenerateXmiUICDOResource extends SafranGeneratorOld_Abs<CDOResource> {
	 ...
	 */
	public GenerateXmiUICDOResource(final CDOResource p_modelURI, final List<? extends Object> p_arguments) {
	...
	protected List<PacmanGeneratorOld_Abs> getPacmanGenerators(final CDOResource p_file,
		...
		v_generators.add(new GenerateXmi(p_file, getServerProject(), p_arguments));
		return v_generators;
	}
