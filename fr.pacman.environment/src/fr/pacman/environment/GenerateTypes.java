 ...
 * @generated NOT
 */
public class GenerateTypes extends PacmanGeneratorOld_Abs {
	/**
	...
	public static final String c_MODULE_FILE_NAME = "generateTypes";
	 ...
	 *                     loaded.
	 */
	public GenerateTypes(final EObject p_model, final File p_targetFolder, final List<? extends Object> p_arguments)
			throws IOException {
		super(p_model, p_targetFolder, p_arguments);
		_TEMPLATE_NAMES = new String[] { "generateTypes" };
	}
	 ...
	 *                     loaded.
	 */
	public GenerateTypes(final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments)
			throws IOException {
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateTypes v_generator = new GenerateTypes(v_modelURI, v_folder, v_arguments);
