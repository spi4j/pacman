...
### Modélisation ###
Pour utiliser les modèles (Cinematic, SOA/DTO, Entity, Database, Requirements, Graal, State Machine & Interaction), 
vous devez les installer sur un bundle "Eclipse Modeling CE".
L'ensemble des modèles est publié sous [ObeoNetwork](http://www.obeonetwork.com/) et sous [git](https://github.com/ObeoNetwork/InformationSystem/tree/master/models) [hub](https://github.com/ObeoNetwork/InformationSystem/tree/master/designs).
