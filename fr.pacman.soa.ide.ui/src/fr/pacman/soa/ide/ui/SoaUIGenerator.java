 ...
 * @author MINARM
 */
public class SoaUIGenerator extends PacmanUIGenerator_Abs {

	/**
	 * Constructor.
	 * 
	 * @param p_selected the selected resource, in this case the root SOA EObject
	 *                   for the model file.
	 */
	public SoaUIGenerator(final System p_selected) {
		super(Collections.singletonList(p_selected));
	}

	/**
	 * Constructor.
	 * 
	 * @param p_selected the selected resource, in this case the SOA model file.
	 */
	public SoaUIGenerator(final IFile p_selected) {
		super(p_selected);
	}
	...
	/**
	 * Get the list for all projects to refresh after the SOA generation. Add here
	 * all necessary project names issued from the {@link PacmanPropertiesManager}.
	 * 
	 ...
	 */
	@Override
	protected List<SafranGenerator_Enum> getCompatibleModels() {
