package fr.pacman.requirement.ui;
...
import fr.pacman.requirement.GenerateCommonRequirement;

/**
 * UI Generator for requirement based on Requirement model file.
 * 
 * @author MINARM
 */
public class RequirementUIGenerators extends PacmanUIGenerator_Abs {
	...
	protected List<PacmanGenerator_Abs> getGenerators() {
		...
		v_generators.add(new GenerateCommonRequirement());
		return v_generators;
	}
	...
	protected List<PacmanUIGenerator_Enum> getCompatibleModels() {
		return Arrays.asList(PacmanUIGenerator_Enum.REQUIREMENT);
	}
