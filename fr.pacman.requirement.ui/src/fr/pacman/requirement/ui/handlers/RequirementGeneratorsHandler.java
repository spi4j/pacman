...
import fr.pacman.requirement.ui.RequirementUIGenerators;

/**
 * UI handler for requirement generator. Generic algorithm for the method but
 * for pacman generators, only unique selection is allowed.
 * 
 * @author MINARM
 */
