...
public final class ReferentielEntityPays
{
    ...
    // Constantes ReferentielEntityPays
   ...
   // Attributs ReferentielEntityPays
   ...
   public static void chargeEntity ()
   {
      ...
      try
      {
        ...
        String [] v_csvLine;
   	    ...
   	    // PreTraitement ReferentielEntityPays
        ...
        while ( ( v_csvLine = v_csvReader.readNext() ) != null )
        {
          ...
          // PostSave ReferentielEntityPays
      ...
      // PostTraitement ReferentielEntityPays
   ...
   // Methodes ReferentielEntityPays
