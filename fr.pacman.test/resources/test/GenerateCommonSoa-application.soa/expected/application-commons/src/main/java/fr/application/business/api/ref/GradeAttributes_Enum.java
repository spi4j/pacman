...
/**
 * L'énumération définissant les informations de chaque attribut pour le type 'Grade'.
 * @author safr@n
 */
public enum GradeAttributes_Enum implements AttributesNames_Itf
{
   /** id. */
   id("id", "id", Long.class, true, -1),
   /** libelle. */
   libelle("libelle", "Le libellé du grade", String.class, true, -1),
   /** trigramme. */
   trigramme("trigramme", "Le trigramme du grade", String.class, true, -1);
    ...
    */
   private GradeAttributes_Enum (final String p_name, final String p_description, final Class<?> p_ClassType, final boolean p_mandatory, final int p_size)
   {
      _name = p_name;
   ...
   public Method getGetterMethod ()
   {
      ...
      {
         _getterMethod = DtoAttributeHelper.getInstance().getGetterMethodForAttribute(GradeDto.class, getName());
      }
   ...
   public Method getSetterMethod ()
   {
      ...
      {
         _setterMethod = DtoAttributeHelper.getInstance().getSetterMethodForAttribute(GradeDto.class, getName(), getType());
      }
