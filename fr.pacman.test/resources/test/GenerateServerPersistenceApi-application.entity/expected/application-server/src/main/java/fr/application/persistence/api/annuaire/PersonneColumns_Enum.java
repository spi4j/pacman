...
/**
 * L'énumeration définissant les informations de chaque colonne pour le type Personne.
 * @author safr@n
 */
public enum PersonneColumns_Enum implements ColumnsNames_Itf
{
   /** personne_id. */
   personne_id("_personne_id", "PERSONNE_ID", Long.class, true, -1, true),
   /** nom. */
   nom("nom", "NOM", String.class, true, 30, false),
   /** prenom. */
   prenom("prenom", "PRENOM", String.class, true, -1, false),
   /** civil. */
   civil("civil", "CIVIL", Boolean.class, true, -1, false),
   /** dateNaissance. */
   dateNaissance("dateNaissance", "DATENAISSANCE", Date.class, true, -1, false),
   /** salaire. */
   salaire("salaire", "SALAIRE", Double.class, true, -1, false),
   /** grade_id. */
      grade_id("grade_id", "GRADE_ID", Long.class, false, -1, false),
   /** marieAvec_id. */
      marieAvec_id("marieAvec_id", "PERSONNE_1_ID", Long.class, false, -1, false),
   /** personneParentDe_id. */
      personneParentDe_id("personneParentDe_id", "PERSONNE_2_ID", Long.class, true, -1, false);
    ...
    */
   private PersonneColumns_Enum (final String p_logicalColumnName, final String p_physicalColumnName,
