...
/**
 * L'énumeration définissant les informations de chaque colonne pour le type Adresse.
 * @author safr@n
 */
public enum AdresseColumns_Enum implements ColumnsNames_Itf
{
   /** adresse_id. */
   adresse_id("_adresse_id", "ADRESSE_POSTALE_ID", Long.class, true, -1, true),
   /** rue. */
   rue("rue", "RUE", String.class, true, -1, false),
   /** ville. */
   ville("ville", "VILLE", String.class, true, -1, false),
   /** codePostal. */
   codePostal("codePostal", "CP", String.class, true, 5, false),
   /** personneAdresses_id. */
      personneAdresses_id("personneAdresses_id", "PERSONNE_ID", Long.class, false, -1, false);

   /**
    * Le nom physique de la table.
    */
   public static final String c_tableName = "AW_ADRESSE_POSTALE";
    ...
    */
   private AdresseColumns_Enum (final String p_logicalColumnName, final String p_physicalColumnName,
