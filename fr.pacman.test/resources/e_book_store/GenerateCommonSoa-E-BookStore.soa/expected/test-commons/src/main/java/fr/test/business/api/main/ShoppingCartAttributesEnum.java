...
/**
 * L'énumération définissant les informations de chaque attribut pour le type 'ShoppingCart'.
 * @author safr@n
 */
public enum ShoppingCartAttributesEnum implements AttributesNames_Itf
{
   ...
   /** status. */
   status("status", "", StatusEnum.class, true, -1),
   /** lines. */
   lines("lines", "", List.class, false, -1);
    ...
    */
   private ShoppingCartAttributesEnum (final String name, final String description, final Class<?> classType, final boolean mandatory, final int size)
   {
      this.name = name;
   ...
   public Method getGetterMethod ()
   {
      ...
      {
         getterMethod = DtoAttributeHelper.getInstance().getGetterMethodForAttribute(ShoppingCartDto.class, getName());
      }
      return getterMethod;
   }
   ...
   public Method getSetterMethod ()
   {
      ...
      {
         setterMethod = DtoAttributeHelper.getInstance().getSetterMethodForAttribute(ShoppingCartDto.class, getName(), getType());
      }
      return setterMethod;
   }
