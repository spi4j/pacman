...
/**
 * L'énumeration définissant les informations de chaque colonne pour le type ShoppingCart.
 * @author safr@n
 */
public enum ShoppingCartColumnsEnum implements ColumnsNames_Itf
{
   ...
   /** userCarts_id. */
   userCarts_id("userCarts_id", "USER_ID", Long.class, false, -1, false);
    ...
    */
   private ShoppingCartColumnsEnum (final String logicalColumnName, final String physicalColumnName,
