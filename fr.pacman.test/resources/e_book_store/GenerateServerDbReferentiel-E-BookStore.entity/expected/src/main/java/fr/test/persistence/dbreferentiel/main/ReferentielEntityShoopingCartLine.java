...
public final class ReferentielEntityShoopingCartLine
{
    ...
    // Constantes ReferentielEntityShoopingCartLine
   ...
   // Attributs ReferentielEntityShoopingCartLine
   ...
   public static void chargeEntity ()
   {
      ...
      try
      {
        ...
        String [] csvLine;
   	    ...
   	    // PreTraitement ReferentielEntityShoopingCartLine
        ...
        while ( ( csvLine = csvReader.readNext() ) != null )
        {
          ...
          // PreSave ReferentielEntityShoopingCartLine
          ...
          // PostSave ReferentielEntityShoopingCartLine
      ...
      // PostTraitement ReferentielEntityShoopingCartLine
   ...
   // Methodes ReferentielEntityShoopingCartLine
