...
public final class ReferentielEntityShoppingCart
{
    ...
    // Constantes ReferentielEntityShoppingCart
   ...
   // Attributs ReferentielEntityShoppingCart
   ...
   public static void chargeEntity ()
   {
      ...
      try
      {
        ...
        String [] csvLine;
   	    ...
   	    // PreTraitement ReferentielEntityShoppingCart
        ...
        while ( ( csvLine = csvReader.readNext() ) != null )
        {
          ...
          // PreSave ReferentielEntityShoppingCart
          ...
          // PostSave ReferentielEntityShoppingCart
      ...
      // PostTraitement ReferentielEntityShoppingCart
   ...
   // Methodes ReferentielEntityShoppingCart
