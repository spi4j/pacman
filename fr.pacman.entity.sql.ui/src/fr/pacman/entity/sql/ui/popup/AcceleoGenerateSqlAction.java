...
import fr.pacman.entity.sql.ui.common.GenerateSqlUI;

/**
 * Entity code generation.
 */
public class AcceleoGenerateSqlAction extends AcceleoGenerateSafranAction<IFile>
{
   ...
   {
      return new GenerateSqlUI(p_modelURI, p_arguments);
   }
