 ...
 */
public class GenerateJdbcUIFromEObject extends SafranGeneratorOld_Abs<EObject> {
	...
	@Override
	protected List<PacmanGeneratorOld_Abs> getPacmanGenerators(final EObject p_input,
