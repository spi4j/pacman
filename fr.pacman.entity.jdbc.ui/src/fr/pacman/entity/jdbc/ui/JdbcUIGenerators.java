package fr.pacman.entity.jdbc.ui;
...
import fr.pacman.entity.api.GenerateCommonEnumEntity;
import fr.pacman.entity.api.GenerateServerPersistenceApi;
import fr.pacman.entity.jdbc.GenerateServerEntityJdbc;

/**
 * UI Generator for JDBC based on Entity model.
 * 
 * @author MINARM
 */
public class JdbcUIGenerators extends PacmanUIGenerator_Abs {
	...
	protected List<PacmanGenerator_Abs> getGenerators() {
		...
		v_generators.add(new GenerateCommonEnumEntity());
		v_generators.add(new GenerateServerEntityJdbc());
		v_generators.add(new GenerateServerPersistenceApi());
		return v_generators;
	}
