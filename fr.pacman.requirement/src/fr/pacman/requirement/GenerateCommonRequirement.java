 ...
 * @author MINARM
 */
public class GenerateCommonRequirement extends PacmanGenerator_Abs {
	...
	public String getModuleQualifiedName() {
		return "fr::pacman::requirement::generateCommonRequirement";
	}
	...
	protected Map<String, SelectionType_Enum> getTemplates() {
		...
		v_templates.put("generateRequirement", SelectionType_Enum.FILE);
		return v_templates;
	}
}
