 ...
 *******************************************************************************/
package fr.pacman.entity.dbpopulate.ui.common;
...
/**
 * Main entry point of the 'Db Populate' generation module.
 */
public class GenerateDbPopulateUI extends SafranGeneratorOld_Abs<IFile> {
	 ...
	 */
	public GenerateDbPopulateUI(final IFile p_modelURI, final List<? extends Object> p_arguments) {
	...
	protected List<PacmanGeneratorOld_Abs> getPacmanGenerators(final IFile p_file,
		...
		v_generators.add(new GenerateDbPopulate(v_modelURI, getServerProject(), p_arguments));
		return v_generators;
	}
