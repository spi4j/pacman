package fr.pacman.entity.dbpopulate.ui;
...
import fr.pacman.entity.api.dbpopulate.GenerateServerDbPopulate;

/**
 * UI Generator for SQL script (populate the created database) based on Entity
 * model file.
 * 
 * @author MINARM
 */
public class DbPopulateUIGenerators extends PacmanUIGenerator_Abs {
	 ...
	 */
	public DbPopulateUIGenerators(final IFile p_selected) {
		super(p_selected);
	}
	...
	protected List<PacmanGenerator_Abs> getGenerators() {
		...
		v_generators.add(new GenerateServerDbPopulate());
		return v_generators;
	}
