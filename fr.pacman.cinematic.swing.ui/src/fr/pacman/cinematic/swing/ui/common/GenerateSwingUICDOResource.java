 ...
 */
public class GenerateSwingUICDOResource extends SafranGeneratorOld_Abs<CDOResource> {
	 ...
	 */
	public GenerateSwingUICDOResource(final CDOResource p_modelURI, final List<? extends Object> p_arguments) {
	...
	protected List<PacmanGeneratorOld_Abs> getPacmanGenerators(final CDOResource p_file,
		...
		v_generators.add(new GenerateCinematicApi(p_file, getClientSwingProject(), p_arguments));
		v_generators.add(new GenerateCinematicSwing(p_file, getClientSwingProject(), p_arguments));
		return v_generators;
	}
