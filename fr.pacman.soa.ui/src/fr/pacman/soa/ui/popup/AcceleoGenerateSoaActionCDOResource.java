...
import fr.pacman.soa.ui.common.GenerateSoaFromCDOResource;

/**
 * Soa code generation.
 */
public class AcceleoGenerateSoaActionCDOResource extends AcceleoGenerateSafranAction<CDOResource>
{
   ...
   {
      return new GenerateSoaFromCDOResource(p_modelURI, p_arguments);
   }
