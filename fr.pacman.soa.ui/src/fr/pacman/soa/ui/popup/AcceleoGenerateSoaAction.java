...
import fr.pacman.soa.ui.common.GenerateSoaFromFile;

/**
 * Soa code generation.
 */
public class AcceleoGenerateSoaAction extends AcceleoGenerateSafranAction<IFile>
{
   ...
   {
      return new GenerateSoaFromFile(p_modelURI, p_arguments);
   }
