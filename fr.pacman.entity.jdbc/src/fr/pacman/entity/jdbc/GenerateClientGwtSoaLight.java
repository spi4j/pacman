 ...
 * @generated NOT
 */
public class GenerateClientGwtSoaLight extends PacmanGeneratorOld_Abs {
	/**
	 * The name of the module.
	 */
	public static final String c_MODULE_FILE_NAME = "generateClientGwtSoaLight";
...
//   }
	 ...
	 *                     loaded.
	 */
	public GenerateClientGwtSoaLight(final EObject p_model, final File p_targetFolder,
		...
		if (p_model instanceof CDOResource) {
			...
			_TEMPLATE_NAMES = new String[] { "GenerateClientGwtEntity" };
		} else {
	 ...
	 *                     loaded.
	 */
	public GenerateClientGwtSoaLight(final URI p_modelURI, final File p_targetFolder,
			final List<? extends Object> p_arguments) throws IOException {
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateClientGwtSoaLight v_generator = new GenerateClientGwtSoaLight(v_modelURI, v_folder,
						v_arguments);
