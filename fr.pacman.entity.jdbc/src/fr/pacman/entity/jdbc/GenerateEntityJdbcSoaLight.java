...
public class GenerateEntityJdbcSoaLight extends PacmanGenerator_Abs {
	 ...
	 */
	public static final String c_MODULE_FILE_NAME = "generateEntityJdbcSoaLight";
...
//   }
	 ...
	 *                     loaded.
	 */
	public GenerateEntityJdbcSoaLight(final EObject p_model, final File p_targetFolder,
	 ...
	 *                     loaded.
	 */
	public GenerateEntityJdbcSoaLight(final URI p_modelURI, final File p_targetFolder,
			final List<? extends Object> p_arguments) throws IOException {
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateEntityJdbcSoaLight v_generator = new GenerateEntityJdbcSoaLight(v_modelURI, v_folder,
						v_arguments);
