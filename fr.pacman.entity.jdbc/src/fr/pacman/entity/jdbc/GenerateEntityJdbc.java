 ...
 * @generated NOT
 */
public class GenerateEntityJdbc extends PacmanGeneratorOld_Abs {
...
//   }
	 ...
	 *                     loaded.
	 */
	public GenerateEntityJdbc(final EObject p_model, final File p_targetFolder,
	 ...
	 *                     loaded.
	 */
	public GenerateEntityJdbc(final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments)
			throws IOException {
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateEntityJdbc v_generator = new GenerateEntityJdbc(v_modelURI, v_folder, v_arguments);
