 ...
 * @generated NOT
 */
public class GenerateEntityJdbcOld extends PacmanGeneratorOld_Abs {

	/**
	 * The name of the module.
	 */
	public static final String c_MODULE_FILE_NAME = "generateEntityJdbc";
...
//   }
	 ...
	 *                     loaded.
	 */
	public GenerateEntityJdbcOld(final EObject p_model, final File p_targetFolder,
		...
		if (p_model instanceof CDOResource) {
			_TEMPLATE_NAMES = new String[] { "implementation" };
		} else if (p_model instanceof Namespace) {
			_TEMPLATE_NAMES = new String[] { "implementationNamespace" };
		} else if (p_model instanceof Entity) {
			_TEMPLATE_NAMES = new String[] { "implementationEntity" };
		} else {
	 ...
	 *                     loaded.
	 */
	public GenerateEntityJdbcOld(final URI p_modelURI, final File p_targetFolder, final List<? extends Object> p_arguments)
			throws IOException {
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateEntityJdbcOld v_generator = new GenerateEntityJdbcOld(v_modelURI, v_folder, v_arguments);
