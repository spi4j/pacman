 ...
 *******************************************************************************/
package fr.pacman.cinematic.jsp;
 ...
 * @generated NOT
 */
public class GenerateCinematicJsp extends PacmanGeneratorOld_Abs {

	/**
	 * The name of the module.
	 */
	public static final String c_MODULE_FILE_NAME = "generateCinematicJsp";
...
//   private List<String> propertiesFiles = new ArrayList<String>();
	 ...
	 *                     loaded.
	 */
	public GenerateCinematicJsp(final EObject p_modelURI, final File p_targetFolder,
	 ...
	 *                     loaded.
	 */
	public GenerateCinematicJsp(final URI p_modelURI, final File p_targetFolder,
			final List<? extends Object> p_arguments) throws IOException {
		super(p_modelURI, p_targetFolder, p_arguments);
	}
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateCinematicJsp v_generator = new GenerateCinematicJsp(v_modelURI, v_folder, v_arguments);
