 ...
 *******************************************************************************/
package fr.pacman.cinematic.jsf;
 ...
 * @generated NOT
 */
public class GenerateCinematicJsf extends PacmanGeneratorOld_Abs {

	/**
	 * The name of the module.
	 */
	public static final String c_MODULE_FILE_NAME = "generateCinematicJsf";
...
//   private List<String> propertiesFiles = new ArrayList<String>();
	 ...
	 *                     loaded.
	 */
	public GenerateCinematicJsf(final EObject p_modelURI, final File p_targetFolder,
	 ...
	 *                     loaded.
	 */
	public GenerateCinematicJsf(final URI p_modelURI, final File p_targetFolder,
			final List<? extends Object> p_arguments) throws IOException {
		super(p_modelURI, p_targetFolder, p_arguments);
		List<String> jsfPropertiesFiles = new ArrayList<String>();
		jsfPropertiesFiles.add("jsf.properties");
		jsfPropertiesFiles.add("toolkits.properties");
		// super.addProperties(jsfPropertiesFiles);
	}
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateCinematicJsf v_generator = new GenerateCinematicJsf(v_modelURI, v_folder, v_arguments);
