 ...
 *******************************************************************************/
package fr.pacman.cinematic.gwt;
 ...
 * @generated NOT
 */
public class GenerateCinematicGwt extends PacmanGeneratorOld_Abs {

	/**
	 * The name of the module.
	 */
	public static final String c_MODULE_FILE_NAME = "generateCinematicGwt";
	 ...
	 *                     loaded.
	 */
	public GenerateCinematicGwt(final EObject p_modelURI, final File p_targetFolder,
	 ...
	 *                     loaded.
	 */
	public GenerateCinematicGwt(final URI p_modelURI, final File p_targetFolder,
			final List<? extends Object> p_arguments) throws IOException {
		super(p_modelURI, p_targetFolder, p_arguments);
	}
	...
	public static void main(final String[] p_args) {
		try {
			if (p_args.length < 2) {
				...
				final GenerateCinematicGwt v_generator = new GenerateCinematicGwt(v_modelURI, v_folder, v_arguments);
